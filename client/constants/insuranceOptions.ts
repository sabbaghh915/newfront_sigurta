...
// ✅ سعات المحرك الشائعة (بالسنتيمتر المكعب)
...
export type SyrianGovernorateValue = (typeof SYRIAN_GOVERNORATES)[number]["value"];
export type EngineCapacityValue = (typeof ENGINE_CAPACITIES)[number]["value"];
