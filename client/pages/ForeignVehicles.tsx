...
import { BORDER_VEHICLE_TYPES, ENGINE_CAPACITIES, SYRIAN_GOVERNORATES } from "../constants/insuranceOptions";
...
export default function ForeignVehicles() {
  ...
  const steps = [
    { number: 1, title: "بيانات المركبة", icon: Globe },
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const vehiclePayload = {
        ...
        governorate: vehicleData.governorate || undefined,
        address,

        plateNumber: vehicleData.plateNumber,
        chassisNumber: vehicleData.chassisNumber,
        engineNumber: vehicleData.engineNumber || undefined,
        engineCapacity: vehicleData.engineCapacity || undefined,
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="governorate">المحافظة في سوريا *</Label>
                    <Select
                ...
                <Card className="bg-red-50 border-red-200">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        <span className="font-medium text-red-700">المحافظة: </span>
                        <span>
                          {SYRIAN_GOVERNORATES.find((g) => g.value === vehicleData.governorate)?.label || "-"}
                        </span>
                      </div>
                      ...
                      <div>
                        <span className="font-medium text-red-700">سعة المحرك: </span>
                        <Badge variant="secondary">
                          {ENGINE_CAPACITIES.find((c) => c.value === vehicleData.engineCapacity)?.label || "غير محدد"}
                        </Badge>
                      </div>
                      <div>
